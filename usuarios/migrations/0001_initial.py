# Generated by Django 5.1.4 on 2024-12-11 00:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endereco', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='usuarios.endereco')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profissional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avaliacoes', to='usuarios.profissional')),
                ('servico', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='usuarios.servico')),
            ],
        ),
    ]
